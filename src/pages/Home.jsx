...
<div className="d-flex justify-content-between w-80">
<h3 className='text-success fw-bold fs-14'>الفاتحة</h3>

    <div>
      <h3 className='float-left fs-14'>Al-Fātiḥah</h3>
      <div className="d-flex align-items-center mt-4 gap-3 mr-35">
         <div className="sora1 d-flex align-items-center"><span className='span-sora'>3دقائق</span><img src={logo2} alt="" /></div>
         <div className="sora1 d-flex align-items-center"><span className='span-sora'>مكية</span><img src={logo3} alt="" /></div>
         <div className="sora1 d-flex align-items-center"><span className='span-sora'>7ايات</span><img src={logo4} alt="" /></div>
...
<div className='position-relative'>
  <span className='span-absolute'>1</span>
<img src={logo1} alt="" />
</div>
</div> */}
